...
update Peliculas set FechaCompra = '15/2/2013' where Titulo = 'La Fiera de mi Niña';
go
...
insert Socios2 (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('27194787R','Pérez Rodríguaz','Antonio','C/La mesa nº 153','92262335','06/12/2012');
go

insert Socios2 (NIFNIE,Apellidos, Nombre, Direccion,Telefono,FechaDeAlta)  values ('14562375F','Pérez Rodríguez','Antonio','C/La silla nº 25','92265212','21/11/2003');
go
